...
ALTER TABLE messagehub.logs_table SET UNLOGGED;
...
ALTER TABLE messagehub.tbl_event_type SET UNLOGGED;
...
ALTER TABLE messagehub.tbl_template_email SET UNLOGGED;
...
ALTER TABLE messagehub.tbl_template_sms SET UNLOGGED;
...
ALTER TABLE messagehub.tbl_template_wechat SET UNLOGGED;
